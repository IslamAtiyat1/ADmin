      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total houses</p>
                {{-- $house->house_name --}}
                <h5 class="font-weight-bolder mb-0">
                    {{-- {{ count($houses->pluck('user.name')) }} --}}
                </h5>
              </div>
            </div>
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Rentors</p>
                <h5 class="font-weight-bolder mb-0">
                  2,300
                </h5>
              </div>
